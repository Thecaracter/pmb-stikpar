    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                <div class="mx-auto h-20 w-20 bg-gradient-to-br from-blue-500 via-cyan-500 to-indigo-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-blue-500/30 mb-8 relative transform hover:scale-105 transition-transform duration-300">
                    <div class="absolute inset-0 bg-gradient-to-br from-white/30 to-white/10 rounded-3xl"></div>
                    <svg class="h-10 w-10 text-white relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
