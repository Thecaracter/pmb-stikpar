                ...
                <div x-show="open" 
                    ...
                    <div class="px-6 py-2">
                        <a href="{{ route('admin.settings.index') }}" 
                           class="w-full group flex items-center justify-center px-6 py-3 text-sm font-semibold text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-xl transition-all duration-300 hover:shadow-md transform hover:scale-[1.02]">
                            <div class="p-2 bg-blue-100 rounded-lg mr-3 group-hover:bg-blue-200 transition-colors shadow-sm">
                            ...
                            <div class="text-center">
                                <div class="font-bold">Pengaturan Sistem</div>
                                <div class="text-xs text-blue-500 font-normal">Kelola konfigurasi</div>
                            </div>
                        </a>
                    </div>
